                ...
                <div class="card-body">
                    <form method="POST" action="{{url('/addteacher')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="firstname" type="text" class="form-control @error('firstname') is-invalid @enderror" value="{{ old('firstname') }}" name="firstname" autocomplete="firstname" autofocus>
                                @error('firstname')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="lastname" type="text" class="form-control @error('lastname') is-invalid @enderror" value="{{ old('lastname') }}" name="lastname" autocomplete="lastname" autofocus>
                                @error('lastname')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" name="email" autocomplete="email">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="gender" type="text" class="form-control @error('gender') is-invalid @enderror" value="{{ old('gender') }}" name="gender" autocomplete="gender" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="altphone" type="text" class="form-control @error('altphone') is-invalid @enderror" value="{{ old('altphone') }}" name="altphone" autocomplete="altphone">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="specialization" type="text" class="form-control @error('specialization') is-invalid @enderror" value="{{ old('specialization') }}" name="specialization" autocomplete="specialization">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="level" type="text" class="form-control @error('level') is-invalid @enderror" name="level" value="{{ old('level') }}" autocomplete="level">
