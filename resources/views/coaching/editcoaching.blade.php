                ...
                <div class="card-body">
                    <form method="POST" action="/coachingupdate" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="altphone" type="tel"
                                       ...
                                       value="{{old('altphone', $data->altphone )}}" autocomplete="altphone">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="directorname" type="text"
                                       ...
                                       name="directorname" value="{{ old('directorname',$data->directorname) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <img src="{{ $data->imgpath ?? asset('/img/default-user.jpg') }}" style="height: 75px; object-fit: cover;">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="specialization" type="text"
                                       ...
                                       name="specialization" value="{{ old('specialization',$data->specialization ) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address1" type="text"
                                       ...
                                       value="{{ old('address1',$data->address1) }}" autocomplete="address1">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address2" type="text"
                                       ...
                                       value="{{ old('address2',$data->address2) }}" autocomplete="address2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="landmark" type="text"
                                       ...
                                       value="{{ old('landmark',$data->landmark ) }}" autocomplete="landmark">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="city" type="text"
                                       ...
                                       value="{{ old('city', $data->city) }}" autocomplete="city">
