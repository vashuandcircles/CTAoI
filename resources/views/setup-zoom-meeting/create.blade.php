        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    Setup Your Zoom Credentials
                    <a href="{{route('zoom-meeting-rooms')}}">
                        <div
                            class="m-2 ml-auto btn btn-primary text-white float-right">Way Create Zoom Credentials
                        </div>
                    </a>

                </div>
                <div class="card-body">
                    <form method="POST" action="{{route('zoom-meeting-config.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="topic" type="text"
                                       ...
                                       placeholder="Enter Zoom Api keys"
                                       value="{{ old('zoom_api_key') }}" name="zoom_api_key" autocomplete="zoom_api_key"
                                       autofocus>
                                @error('zoom_api_key')
