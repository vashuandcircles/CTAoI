            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="banner_content text-center">
                        ...
                        <div class="page_link">
                            <a href="{{url('/')}}">Home</a>
                            <a href="{{url('/registerteacher')}}">Register Teacher</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="container m-4">
    ...
    <form method="POST" action="{{url('/addteacheruser')}}" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('POST') }}
        <div class="form-group row">
            <label for="firstname" class="col-md-2 col-form-label text-md-right">First Name</label>
            <div class="col-md-4">
                <input id="firstname" type="text" class="single-input form-control @error('firstname') is-invalid @enderror" value="{{ old('firstname') }}" name="firstname" autocomplete="firstname" autofocus>
                @error('firstname')
            ...
            <div class="col-md-4">
                <input id="lastname" type="text" class="single-input form-control @error('lastname') is-invalid @enderror" value="{{ old('lastname') }}" name="lastname" autocomplete="lastname" autofocus>
                @error('lastname')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-4">
                <textarea id="description" class="single-input form-control @error('description') is-invalid @enderror" value="{{ old('description') }}" name="description"></textarea>
        ...
        <div class="form-group row">
            ...
            <label for="address" class="col-md-2 col-form-label text-md-right">Street Address</label>
            <div class="col-md-4">
                <input id="address" type="text" class="single-input form-control @error('address') is-invalid @enderror" value="{{ old('address') }}" name="address">
                @error('address')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
