            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST"
                              action="{{route('teachers.meetings.'.$route,isset($meeting)? $meeting['id']:'' )}}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="topic" type="text"
                                           ...
                                           name="topic" autocomplete="topic" autofocus>
                                    @error('topic')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="start_time" type="datetime-local"
                                           ...
                                           value="{{ old('start_time', $meeting['start_time'] ? \Carbon\Carbon::parse($meeting['start_time'])->toDateTimeLocalString() :'') }}"
