...
.s01 {
  ...
  -ms-flex-align: center;
      align-items: center;
  background: url("../img/search-back.jpg") no-repeat center;
...
<div class="s01">
      <form>
        <fieldset>
          <legend>Discover our amazing solutions</legend>
        </fieldset>
    ...
    <div id="alldata" class="alldata"></div>
